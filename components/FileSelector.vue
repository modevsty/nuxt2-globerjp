<template>
  <v-container style="margin-top: 20px; width: 100%; height: fit-content">
    <div style="width: 100%; height: 250px; overflow: scroll">
      <div class="d-flex flex-row flex-wrap justify-center align-center">
        <div style="width:100px; height: 100px;position:relative; overflow: visible; margin: 6px;" v-for="(img, i) in userRepo.images" :key="i" >
          <v-icon
          ...
          >
          <v-img
            style="border: thin solid rgba(0,0,0,0.12); height:100px; width: 100px; object-fit:cover;"
            :alt="'img-' + i"
            :src="imgFailed? '/img/image-not-found.png':img.teaserImageUrl"
