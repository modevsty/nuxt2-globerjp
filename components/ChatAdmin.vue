<template>
  <div v-if="pageLoaded" class="chatadmin-container" :class="{ 'window-mobile': isDevice }">
    ...
    <client-only>
      ...
      :show-emojis="false"
			:show-add-room="rooms && !rooms.length"
...
export default {
    ...
    getUsers() {
      ...
      await this.roomsRef.add({
				eventId: this.eventId,
				creatorId: this.user.uid,
				users: [...ids, this.currentUserId],
